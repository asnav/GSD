...
//  GSD
//
//  Created by Asaf Navon on 5/17/25.
//
...
struct ProgressRing: View {
            ...
            ZStack {
                ...
                if self.getShowShadow(frame: geometry.size) {
                    Circle()
                        ...
                        .shadow(color: ProgressRing.ShadowColor,
                                radius: ProgressRing.ShadowRadius,
    ...
    private func getEndCircleShadowOffset() -> (CGFloat, CGFloat) {
        ...
        let xOffset = relativeXOffset.toCGFloat() * ProgressRing.ShadowOffsetMultiplier
        let yOffset = relativeYOffset.toCGFloat() * ProgressRing.ShadowOffsetMultiplier
    ...
    var body: some View {
        Group {
            ZStack{
                Color.black
                ProgressRing(
                    ringWidth: 20, percent: 3,
                    backgroundColor: Color.red.opacity(0.3),
                    foregroundColors: [
                        Color(UIColor(red: 0.843, green: 0.149, blue: 0.22, alpha: 0.5)),
                        Color(UIColor(red: 0.843, green: 0.149, blue: 0.22, alpha: 1)),
                    ]
                )
